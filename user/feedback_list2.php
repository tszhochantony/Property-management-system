  ...
  $(document).ready(function() {
    ...
    var showContent = function($record_id,$title,$content,$resopnder_id,$action_type) {
      ...
      if($action_type=='responded'){
        ...
        $('#response_list  > tbody:last-child').append('<tr><td><a href="feedback_details.php?rId=' + $record_id + '"' + 'target="popup"> <button type="button" name="button"><?=$view_details?></button> </a></td></tr>');
